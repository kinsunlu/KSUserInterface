...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        [playButton setImage:[UIImage imageNamed:@"KSUserInterface.bundle/icon_video_play"] forState:UIControlStateNormal];
        [playButton setImage:[UIImage imageNamed:@"KSUserInterface.bundle/icon_video_pause"] forState:UIControlStateSelected];
...
- (void)layoutSubviews {
    ...
    CGSize k_size = [_playButton sizeThatFits:windowSize];
    CGFloat viewX = (windowSize.width-k_size.width)*0.5;
    CGFloat viewY = (windowSize.height-k_size.height)*0.5;
    _playButton.frame = (CGRect){viewX, viewY, k_size};
}
