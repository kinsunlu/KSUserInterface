...
- (void)pushAnimation:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    [UIView animateWithDuration:k_transitionTime delay:0.0 usingSpringWithDamping:0.7 initialSpringVelocity:15.0 options:UIViewAnimationOptionShowHideTransitionViews animations:^{
